...
const page = () => {
  return (
    ...
    <div className="container">
      <h1
        className="title mb-20 text-primary relative after:absolute after:left-0 after:-bottom-4 after:w-40 after:h-[5px] after:bg-secondary">
      ...
      <div className="space-y-8">
        <div className="space-y-4">
          ...
          <p>
            ...
            mit anderen über die Zwecke und Mittel der Verarbeitung entscheiden. Zudem informieren wir Sie nachfolgend
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <p className="font-bold">Z management consulting (ZMC)</p>
            <ul>
              <li>
                <a href="#" aria-label="">
                  Königstraße 27 <br/>
              ...
              <li>
                <a href="tel:+4971149050391" aria-label="">
                  Telefon: +49 711 - 490 50 391
                </a>
              </li>
              <li>
                <a href="tel:+497114905025" aria-label="">
                  Telefax: +49 711 - 490 50 25
                </a>
              </li>
              <li>
                <a href="mailto:v.zimmerer@z-management-consulting.com" aria-label="">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <p className="font-bold">Z management consulting (ZMC)</p>
            <ul className="space-y-4 list-disc list-dot">
              <li>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-4 list-disc list-dot">
              <li className="space-y-2">
                <b>Sitzungs-Cookies/Session-Cookies</b>
                <ul className="space-y-2">
                  ...
                  <li>
                    Rechtsgrundlage dieser Verarbeitung ist Art. 6 Abs. 1 lit b.) DSGVO, sofern diese Cookies Daten
                    zur Vertragsanbahnung oder Vertragsabwicklung verarbeitet werden.
                  </li>
                  <li>
              ...
              <li className="space-y-2">
                ...
                <ul className="space-y-2">
                  <li>
                    ...
                    hierfür erforderlichen Schritte und Maßnahmen hängen jedoch von Ihrem konkret genutzten
                    Internet-Browser ab. Bei Fragen benutzen Sie daher bitte die Hilfefunktion oder Dokumentation
                    Ihres Internet-Browsers oder wenden sich an dessen Hersteller bzw. Support. Bei sog. Flash-Cookies
                    kann die Verarbeitung allerdings nicht über die Einstellungen des Browsers unterbunden werden.
                    Stattdessen müssen Sie insoweit die Einstellung Ihres Flash-Players ändern. Auch die hierfür
                    erforderlichen Schritte und Maßnahmen hängen von Ihrem konkret genutzten Flash-Player ab. Bei
                    Fragen benutzen Sie daher bitte ebenso die Hilfefunktion oder Dokumentation Ihres Flash-Players
        ...
        <div className="space-y-4">
          ...
          <p>
            Diese so erhobenen Daten werden vorrübergehend gespeichert, dies jedoch nicht gemeinsam mit anderen Daten
            von Ihnen.
          </p>
        </div>
      </div>
